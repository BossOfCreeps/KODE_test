...
from account.crud import create_auth_token, create_user, get_user_by_login
from account.schemas import UserCreate, AuthToken
...
@router.post("/account/login", response_model=AuthToken, responses={404: {"model": Scheme404}})
...
@router.post("/account/reg", response_model=AuthToken, responses={400: {"model": Scheme404}})
